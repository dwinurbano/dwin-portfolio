    ...
    <div name="home" className='w-full h-full sm:h-screen bg-gradient-to-b from-black via-black to-cyan-700'>
      <div className= "flex flex-col items-center justify-center h-full max-w-screen-lg px-4 mx-auto md:flex-row">
        <div className = "flex flex-col justify-center h-full sm:pr-20 ">
          ...
          <p className = 'max-w-2xl py-2 text-gray-400'>
          Motivated and detail-oriented computer engineering student looking for entry-level positions to leverage my technical skills and contribute to the development of innovative software and hardware solutions. Can also work under pressure and in a competitive environment.
          </p>
